...
qemurun:
	$(QEMU) -cdrom $(TARGET) -m 2048 -rtc base=localtime -M pc -boot d

debugrun: 
	$(QEMU) -cdrom $(TARGET) -m 2048 -rtc base=localtime -M pc -boot d -s -S -serial stdio
