    ...
    class DeviceManager {
        public:
            void Initialize(void) {
                DeviceList = (StandardDeviceInfo *)MemoryManagement::Allocate(PCI_MAX_DEVICE_COUNT*sizeof(StandardDeviceInfo));
                DeviceCount = 0;
            }
            ...
            static DeviceManager *GetInstance(void) {
                ...
                if(Instance == 0x00) {
                    Instance = (DeviceManager *)MemoryManagement::Allocate(sizeof(DeviceManager));
                    return Instance;
                }
                return Instance;
            }
